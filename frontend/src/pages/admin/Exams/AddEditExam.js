                ...
                <Tabs defaultActiveKey='1'>
                    <TabPane tab="Exam Details" key='1'>
                        <Row gutter={[10, 10]}>
                            ...
                            <Col span={8}>
                                <Form.Item label='Pass marks' name='passingMarks'>
                                    <input type='number' />
                                </Form.Item>
                            </Col>
                            <Col span={8}>
                                <Form.Item label='Reference material' name='reference'>
                                    <input type='text' />
                                </Form.Item>
                            </Col>
                        </Row>
                        <div className='flex justify-end gap-2'>
                    <button className='primary-contained-btn' type='button' onClick={() => navigate('/admin/exams')}>Cancel</button>
